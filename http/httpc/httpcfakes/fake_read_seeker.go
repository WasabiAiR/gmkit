...
func (fake *FakeReadSeeker) Seek(arg1 int64, arg2 int) (int64, error) {
	...
	fake.recordInvocation("Seek", []any{arg1, arg2})
...
func (fake *FakeReadSeeker) Invocations() map[string][][]any {
...
func (fake *FakeReadSeeker) recordInvocation(key string, args []any) {
...
var _ io.ReadSeeker = new(FakeReadSeeker)
